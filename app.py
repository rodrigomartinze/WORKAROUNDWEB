...
app = Flask(__name__)
app.secret_key = 'tu_clave_secreta_aqui_cambiar_en_produccion'  # Cambia esto en producción
    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if usuario:
                ...
                if usuario['Password'] == password:  # Cambia esto cuando agregues campo password
